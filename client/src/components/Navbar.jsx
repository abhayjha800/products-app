...
import { SignInButton, SignUpButton, SignOutButton, SignedIn, SignedOut, UserButton, useAuth } from "@clerk/clerk-react"
            ...
            <div className="max-w-5xl mx-auto w-full px-4 flex justify-between items-center">
                <div className="flex-1">
                    <Link to="/" className="btn btn-ghost gap-2">
                        ...
                        <span className="text-lg font-mono uppercase tracking-wider">Productify</span>
                    </Link>
                </div>
